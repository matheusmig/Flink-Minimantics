...
class Profile(object):
	...
	def loglike(self):
		...
		if self.ew1w2 != 0:
			r1 = self.PRODLOG( self.targetContextCount , decimal.Decimal(self.targetContextCount / self.ew1w2) );

		if self.ew1nw2 != 0:
			r2 = self.PRODLOG( self.cw1nw2             , decimal.Decimal(self.cw1nw2  / self.ew1nw2)  );

		if self.enw1w2 != 0:
			r3 = self.PRODLOG( self.cnw1w2             , decimal.Decimal(self.cnw1w2  / self.enw1w2)  );

		if self.enw1nw2 != 0:
			r4 = self.PRODLOG( self.cnw1nw2            , decimal.Decimal(self.cnw1nw2 / self.enw1nw2) );
